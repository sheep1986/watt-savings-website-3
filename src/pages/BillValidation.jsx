...
const BillValidation = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Energy Bill Validation UK | Business Bill Audit Services | Watt Savings</title>
            ...
            {commonErrors.map((error, index) => (
              ...
              >
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                  <div className="font-semibold text-green-800 text-sm">Typical Recovery:</div>
                  <div className="text-green-600 font-bold">{error.avgSaving}</div>
                </div>
              </motion.div>
            ))}
          </div>
            ...
            {recoveryExamples.map((example, index) => (
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="bg-green-100 text-green-800 px-3 py-2 rounded-full text-lg font-bold">
                    {example.recovery}
                  </div>
                </div>
